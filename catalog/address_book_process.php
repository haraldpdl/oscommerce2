    ...
    if ($error == false) {
      ...
      if ($_POST['action'] == 'update') {
        ...
        if (tep_db_num_rows($check_query) == 1) {
          tep_db_perform('address_book', $sql_data_array, 'update', "address_book_id = '" . (int)$_GET['edit'] . "' and customers_id ='" . (int)$_SESSION['customer_id'] . "'");
...
// reregister session variables
          if ( (isset($_POST['primary']) && ($_POST['primary'] == 'on')) || ($_GET['edit'] == $_SESSION['customer_default_address_id']) ) {
            ...
            tep_db_perform('customers', $sql_data_array, 'update', "customers_id = '" . (int)$_SESSION['customer_id'] . "'");
          }
    ...
    <div class="col-sm-4">
      <div class="panel panel-danger">
        ...
        <div class="panel-body">
          <?php echo tep_address_label($_SESSION['customer_id'], (int)$_GET['delete'], true, ' ', '<br />'); ?>
        </div>
      </div>
    </div>
  </div>
