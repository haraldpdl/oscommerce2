...
*/
  ...
  if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'process') && isset($HTTP_POST_VARS['formid']) && ($HTTP_POST_VARS['formid'] == $sessiontoken)) {
    ...
    if (tep_db_num_rows($check_customer_query)) {
      ...
      tep_db_query("update " . TABLE_CUSTOMERS . " set customers_password = '" . tep_db_input($crypted_password) . "', customers_authentication_type = 1 where customers_id = '" . (int)$check_customer['customers_id'] . "'");
      ...
      if ($check_customer['customers_authentication_type'] != '1') {
        $messageStack->add_session('login', SUCCESS_PASSWORD_SENT_AUTH_RESET, 'success');
      } else {
