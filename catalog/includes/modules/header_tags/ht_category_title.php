    ...
    public function execute() {
      ...
      if (basename($PHP_SELF) == 'index.php') {
        if ($current_category_id > 0) {
          $categories_query = tep_db_query("select categories_name, categories_seo_title from :table_categories_description where categories_id = '" . (int)$current_category_id . "' and language_id = '" . (int)$_SESSION['languages_id'] . "' limit 1");
