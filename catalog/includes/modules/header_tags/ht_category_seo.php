  ...
  class ht_category_seo {
    ...
    public function execute() {
      ...
      if ( (basename($PHP_SELF) == 'index.php') && ($current_category_id > 0) ){
        $meta_info_query = tep_db_query("select categories_seo_description, categories_seo_keywords from :table_categories_description where categories_id = '" . (int)$current_category_id  . "' and language_id = '" . (int)$_SESSION['languages_id'] . "'");
