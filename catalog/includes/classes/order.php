...
*/
  ...
  class order {
    ...
    public function query($order_id) {
      ...
      $order_status_query = tep_db_query("select orders_status_name from :table_orders_status where orders_status_id = '" . (int)$order['orders_status'] . "' and language_id = '" . (int)$_SESSION['languages_id'] . "'");
