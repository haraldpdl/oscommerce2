...
*/
  ...
  if ( isset($_GET['action']) ) {
    if ( ($_GET['action'] == 'delete') && isset($_GET['id']) && is_numeric($_GET['id']) && isset($_GET['formid']) && ($_GET['formid'] == md5($_SESSION['sessiontoken']))) {
      $token_query = tep_db_query("select id, braintree_token from :table_customers_braintree_tokens where id = '" . (int)$_GET['id'] . "' and customers_id = '" . (int)$_SESSION['customer_id'] . "'");
