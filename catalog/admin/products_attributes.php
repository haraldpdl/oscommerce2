...
<?php
      $products = tep_db_query("select p.products_id, pd.products_name from :table_products p, :table_products_description pd where pd.products_id = p.products_id and pd.language_id = '" . (int)$_SESSION['languages_id'] . "' order by pd.products_name");
      while($products_values = tep_db_fetch_array($products)) {
...
<?php
      $options = tep_db_query("select * from :table_products_options where language_id = '" . (int)$_SESSION['languages_id'] . "' order by products_options_name");
      while($options_values = tep_db_fetch_array($options)) {
...
<?php
      $values = tep_db_query("select * from :table_products_options_values where language_id ='" . (int)$_SESSION['languages_id'] . "' order by products_options_values_name");
      while($values_values = tep_db_fetch_array($values)) {
...
<?php
      if (DOWNLOAD_ENABLED == 'true') {
        $download_query_raw ="select products_attributes_filename, products_attributes_maxdays, products_attributes_maxcount
                              ...
                              where products_attributes_id='" . (int)$attributes_values['products_attributes_id'] . "'";
