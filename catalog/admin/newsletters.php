  ...
  if (tep_not_null($action)) {
    switch ($action) {
      ...
      case 'unlock':
        ...
        tep_db_query("update :table_newsletters set locked = '" . (int)$status . "' where newsletters_id = '" . (int)$newsletter_id . "'");
      ...
      case 'update':
        ...
        if (empty($newsletter_module) || !is_file(DIR_FS_ADMIN . 'includes/modules/newsletters/' . $newsletter_module . '.php')) {
