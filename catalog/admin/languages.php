...
// create additional orders_status records
        $orders_status_query = tep_db_query("select orders_status_id, orders_status_name, public_flag, downloads_flag from :table_orders_status where language_id = '" . (int)$_SESSION['languages_id'] . "'");
