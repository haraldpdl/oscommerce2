...
*/
  ...
  class product_notification {
    ...
    public function choose_audience() {
      ...
      $products_query = tep_db_query("select pd.products_id, pd.products_name from :table_products p, :table_products_description pd where pd.language_id = '" . (int)$_SESSION['languages_id'] . "' and pd.products_id = p.products_id and p.products_status = '1' order by pd.products_name");
