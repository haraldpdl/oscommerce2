...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr class="headerBar">
    ...
    <td class="headerBarContent" align="right"><?php echo (isset($_SESSION['admin']) ? 'Logged in as: ' . $_SESSION['admin']['username']  . ' (<a href="' . tep_href_link('login.php', 'action=logoff') . '" class="headerLink">Logoff</a>)' : ''); ?>&nbsp;&nbsp;</td>
  </tr>
</table>