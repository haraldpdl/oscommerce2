...
<?php
        ...
        while ($addresses = osc_db_fetch_array($addresses_query)) {
         ...
         if ($addresses['address_book_id'] == $OSCOM_Order->getShippingAddress('id')) {
...
?>
        ...
        <td align="right"><?php echo osc_draw_radio_field('address', $addresses['address_book_id'], ($addresses['address_book_id'] == $OSCOM_Order->getShippingAddress('id'))); ?></td>
      </tr>
      <tr>
